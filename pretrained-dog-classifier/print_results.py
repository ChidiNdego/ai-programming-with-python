...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("\n\n*** Results Summary for CNN Model Architecture: {}".format(model), 
          "***")
    ...
    print("\n\n*** Result Summary (%) for CNN Model Architecture: {}".format(model),"***")
    ...
    if (print_incorrect_breed and 
        ...
        for key in results_dic:
            ...
            #if (results_dic[key][3] == 1 and results_dic[key][4] == 1) or (results_dic[key][3] == 0 and results_dic[key][4] == 0):
            #    print("{:20}: {:20}".format(results_dic[key][0], results_dic[key][1]))
